...
export const MobileBottomNav: React.FC<MobileBottomNavProps> = ({ currentScreen, onNavigate, userRole }) => {
 ...
 const coachTabs:{id:ScreenView;label:string;icon:string}[]=[{id:'coach_dashboard',label:'Início',icon:'dashboard'},{id:'prescription',label:'Alunos',icon:'groups'},{id:'student_progress',label:'Evolução',icon:'monitoring'},{id:'agenda',label:'Agenda',icon:'calendar_month'},{id:'chat',label:'Chat',icon:'chat'}];
