...
export const MobileBottomNav: React.FC<MobileBottomNavProps> = ({ currentScreen, onNavigate, userRole }) => {
  const studentTabs:{id:ScreenView;label:string;icon:string}[]=[
    {id:'student_hub',label:'Início',icon:'home'},
    {id:'student_daily',label:'Treino',icon:'fitness_center'},
    {id:'student_progress',label:'Evolução',icon:'trending_up'},
    {id:'chat',label:'Chat',icon:'chat'},
    {id:'student_profile',label:'Perfil',icon:'person'},
  ];
  const coachTabs:{id:ScreenView;label:string;icon:string}[]=[
    {id:'coach_dashboard',label:'Início',icon:'dashboard'},
    {id:'prescription',label:'Alunos',icon:'groups'},
    {id:'student_progress',label:'Evolução',icon:'monitoring'},
    {id:'agenda',label:'Agenda',icon:'calendar_month'},
    {id:'chat',label:'Chat',icon:'chat'},
  ];
  const adminTabs:{id:ScreenView;label:string;icon:string}[]=[
    {id:'admin_system',label:'Admin',icon:'admin_panel_settings'},
    {id:'assinatura',label:'Receita',icon:'payments'},
  ];
