...
import { BrandThemeBridge } from './components/BrandThemeBridge';
...
const CoachDashboardScreen=lazy(()=>import('./components/Screens/CoachDashboardScreen').then(m=>({default:m.CoachDashboardScreen})));
const CoachPerformanceQuickPanel=lazy(()=>import('./components/Screens/CoachPerformanceQuickPanel').then(m=>({default:m.CoachPerformanceQuickPanel})));
const GrowthScreen=lazy(()=>import('./components/Screens/GrowthScreen').then(m=>({default:m.GrowthScreen})));
const BrandKitScreen=lazy(()=>import('./components/Screens/BrandKitScreen').then(m=>({default:m.BrandKitScreen})));
const PublicCoachScreen=lazy(()=>import('./components/Screens/PublicCoachScreen').then(m=>({default:m.PublicCoachScreen})));
const PrescriptionScreen=lazy(()=>import('./components/Screens/PrescriptionScreen').then(m=>({default:m.PrescriptionScreen})));
const FitnessToolsScreen=lazy(()=>import('./components/Screens/FitnessToolsScreen').then(m=>({default:m.FitnessToolsScreen})));
const PhysicalTestsPanel=lazy(()=>import('./components/Screens/PhysicalTestsPanel').then(m=>({default:m.PhysicalTestsPanel})));
const PosturalAssessmentScreen=lazy(()=>import('./components/Screens/PosturalAssessmentScreen').then(m=>({default:m.PosturalAssessmentScreen})));
const GamificationRankingScreen=lazy(()=>import('./components/Screens/GamificationRankingScreen').then(m=>({default:m.GamificationRankingScreen})));
const StudentDetailScreen=lazy(()=>import('./components/Screens/StudentDetailScreen').then(m=>({default:m.StudentDetailScreen})));
const StudentReportProPanel=lazy(()=>import('./components/Screens/StudentReportProPanel').then(m=>({default:m.StudentReportProPanel})));
const StudentHubScreen=lazy(()=>import('./components/Screens/StudentHubScreen').then(m=>({default:m.StudentHubScreen})));
const StudentDailyScreen=lazy(()=>import('./components/Screens/StudentDailyScreen').then(m=>({default:m.StudentDailyScreen})));
const WorkoutExecutionScreen=lazy(()=>import('./components/Screens/WorkoutExecutionScreen').then(m=>({default:m.WorkoutExecutionScreen})));
const StudentProgressScreen=lazy(()=>import('./components/Screens/StudentProgressScreen').then(m=>({default:m.StudentProgressScreen})));
const StudentCheckinScreen=lazy(()=>import('./components/Screens/StudentCheckinScreen').then(m=>({default:m.StudentCheckinScreen})));
const StudentProfileScreen=lazy(()=>import('./components/Screens/StudentProfileScreen').then(m=>({default:m.StudentProfileScreen})));
const AnamneseScreen=lazy(()=>import('./components/Screens/AnamneseScreen').then(m=>({default:m.AnamneseScreen})));
const ChatScreen=lazy(()=>import('./components/Screens/ChatScreen').then(m=>({default:m.ChatScreen})));
const AgendaScreen=lazy(()=>import('./components/Screens/AgendaScreen').then(m=>({default:m.AgendaScreen})));
const AssinaturaScreen=lazy(()=>import('./components/Screens/AssinaturaScreen').then(m=>({default:m.AssinaturaScreen})));
const AdminDashboardScreen=lazy(()=>import('./components/Screens/AdminDashboardScreen').then(m=>({default:m.AdminDashboardScreen})));
const ProductionReadinessPanel=lazy(()=>import('./components/Screens/ProductionReadinessPanel').then(m=>({default:m.ProductionReadinessPanel})));
const AdminMasterCenter=lazy(()=>import('./components/Screens/AdminMasterCenter').then(m=>({default:m.AdminMasterCenter})));
const AdminPerformancePanel=lazy(()=>import('./components/Screens/AdminPerformancePanel').then(m=>({default:m.AdminPerformancePanel})));
const AdminCoachCredentialsPanel=lazy(()=>import('./components/Screens/AdminCoachCredentialsPanel').then(m=>({default:m.AdminCoachCredentialsPanel})));

const LoadingScreen=()=> <div className="min-h-[240px] grid place-items-center text-[#DFFF00] font-mono text-xs uppercase tracking-[.2em]">Carregando módulo...</div>;
...
const ACCESS:Record<'admin'|'coach'|'student',ScreenView[]>={
 ...
 coach:['landing','coach_dashboard','coach_growth','brand_kit','prescription','fitness_tools','postural_assessment','gamification_ranking','student_detail','student_progress','anamnese','chat','agenda','assinatura'],
...
export default function App(){
 ...
 if(publicCoachSlug)return <Suspense fallback={<LoadingScreen/>}><PublicCoachScreen slug={publicCoachSlug}/></Suspense>;
