...
$thumbs=(int)$pdo->query("SELECT COUNT(*) FROM exercise_library WHERE is_system=1 AND media_url LIKE 'data:image/svg+xml%'")->fetchColumn();if($thumbs<100)throw new RuntimeException('Miniaturas automáticas não foram geradas.');
...
echo "Branding smoke OK: {$count} exercícios PT-BR, miniaturas e Brand Kit.\n";
