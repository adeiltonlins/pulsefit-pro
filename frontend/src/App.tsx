...
const ACCESS:Record<'admin'|'coach'|'student',ScreenView[]>={
 ...
 coach:['landing','coach_dashboard','coach_growth','prescription','student_detail','student_progress','anamnese','chat','agenda','assinatura'],
